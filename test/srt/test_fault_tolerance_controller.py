...
def test_pause_kill_then_retry_allows_dead_rank():
    ...
    active_mask, resume_targets = manager.begin_recover("retry")
...
def test_continue_kill_marks_dead_without_pause():
    ...
    assert manager.ranks[2].state == RankState.DEAD
