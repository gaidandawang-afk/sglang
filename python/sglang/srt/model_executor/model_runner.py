...
class ModelRunner:
    ...
    def recover_npu_device_for_fault_tolerance(self) -> None:
    ...
    def update_npu_fault_tolerance_mc2(self, active_mask: list[bool]) -> None:
        state = ElasticEPStateManager.instance()
        state.update_npu_mc2_elastic_info()
        from sglang.srt.elastic_ep.npu_mc2 import validate_mc2_scale_down_routing
